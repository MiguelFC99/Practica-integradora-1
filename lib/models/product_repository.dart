  ...
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if (prodType == ProductType.TAZAS) {
      ...
      return <ProductCup>[
        ProductCup(
            productTitle: "Anzac",
            productDescription: "Taza en forma de barril algo redondeada.",
            productImage:
                "https://articulospromocionalescdmx.com/wp-content/uploads/2019/08/TAZ-025-B.jpg",
            productColor: ProductColor.M,
            productAmount: 0),
        ProductCup(
            productTitle: "Asa",
            productDescription: "Taza personalizada",
            productImage: "https://personalizatufunda.es/wp-content/uploads/2018/08/TAZA-CON-ASA-DE-COLORES-VERDE-CLARO-Copy-300x300.jpg",
            productColor: ProductColor.M,
            productAmount: 0
        ),
        ProductCup(
            productTitle: "Taza grande",
            productDescription: "Taza exclusiva de cristal",
            productImage: "https://images-na.ssl-images-amazon.com/images/I/61%2BRbnVkuYL._SX522_.jpg",
            productColor: ProductColor.M,
            productAmount: 0
        ),
        ProductCup(
            productTitle: "Taza galletas",
            productDescription: "Taza con compartimiento para galletas",
            productImage: "https://playandcake.files.wordpress.com/2013/03/tazas-originales1.jpg",
            productColor: ProductColor.M,
            productAmount: 0
        ),
        ProductCup(
            productTitle: "CustomCup",
            productDescription: "Tazas decoradas al estilo deseado",
            productImage: "https://images-eu.ssl-images-amazon.com/images/I/51hu92BDPOL.jpg",
            productColor: ProductColor.M,
            productAmount: 0
        ),
      ];
